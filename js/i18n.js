...
const translations = {
  es: {
    ...
    "hero.subtitle":     "Transformando lógica compleja en interfaces fluidas. Especialista en elicitación de requisitos, arquitecturas Full-Stack y automatización inteligente con IA.",
    ...
    "about.p1":         "Soy Analista y Desarrollador de Software en formación en el SENA, con un enfoque profundo en la elicitación de requisitos, arquitecturas Full-Stack y el diseño de interfaces de alto impacto. Mi objetivo es siempre equilibrar robustez técnica con experiencias de usuario impecables.",
  ...
  en: {
    ...
    "hero.subtitle":     "Turning complex logic into fluid interfaces. Specialist in requirements elicitation, Full-Stack architectures, and intelligent AI automation.",
    ...
    "about.p1":         "I'm a Software Analyst & Developer studying at SENA, with a deep focus on requirements elicitation, Full-Stack architectures, and high-impact interface design. My goal is always to balance technical robustness with impeccable user experiences.",
